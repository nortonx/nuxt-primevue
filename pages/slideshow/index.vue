          ...
          <TabPanel header="Image Component">
            <div class="card">
              <Image v-for="image in images" :key="image.src" preview class="w-3 m-1">
                ...
                <template #image>
                  <img :src="image.itemImageSrc" :alt="image.alt" class="w-full" />
                </template>
                <template #preview>
                  <img :src="image.itemImageSrc" alt="Preview" class="w-full" />
                </template>
              </Image>
            </div>
          </TabPanel>
                ...
                <div class="border-1 surface-border border-round m-2 p-3">
                  <div class="mb-3">
                    <div class="relative mx-auto">
                      <img :src="slotProps.data.itemImageSrc" :alt="slotProps.data.alt" class="w-full border-round" />
                    </div>
                  </div>
                  <div class="mb-3 font-medium">{{ slotProps.data.alt }}</div>
                  <div class="flex justify-content-between align-items-center">
                    <div class="mt-0 font-semibold text-xl">10.00</div>
                    <span>
                      <Button icon="pi pi-search" severity="secondary" outlined></Button>
