...
const products: Product[] = [
  {
    ...
    subtotal: computed(
      () =>
        ...
        (products[0].price * products[0].quantity * randomValue.value) / 100,
    ),
  },
  {
    id: 2,
    ...
    subtotal: computed(
      () =>
        ...
        (products[1].price * products[1].quantity * randomValue.value) / 100,
    ),
  },
  {
    id: 3,
    ...
    subtotal: computed(
      () =>
        ...
        (products[2].price * products[2].quantity * randomValue.value) / 100,
    ),
  },
];
